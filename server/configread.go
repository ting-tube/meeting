...
func InitConfig(c *Config) {
	...
	c.ICEServers = []ICEServer{{
		URLs: []string{"//77.73.69.56:3478"}, //URLs: []string{"stun:stun.l.google.com:19302"},
	}, {
		URLs: []string{"//77.73.69.56:3478"}, //URLs: []string{"stun:global.stun.twilio.com:3478?transport=udp"},
	}}
}
